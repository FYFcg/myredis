        ...
        pub mod example {
            ...
            impl ::pilota::thrift::Message for GetItemRequest {
                fn encode<T: ::pilota::thrift::TOutputProtocol>(
                    ...
                    protocol.write_struct_begin(&struct_ident)?;
                    protocol.write_i32_field(1, (*&self.command).into())?;
                ...
                fn decode<T: ::pilota::thrift::TInputProtocol>(
                    ...
                    if let Err(err) = (|| {
                        loop {
                            ...
                            match field_ident.id {
                                ...
                                {
                                    command = Some(::pilota::thrift::Message::decode(protocol)?);
                                }
                                Some(2)
                                    if field_ident.field_type
                    ...
                    let Some(command) = command else {
                        return Err(::pilota::thrift::DecodeError::new(
                            ::pilota::thrift::DecodeErrorKind::InvalidData,
                            "field command is required".to_string(),
                        ));
                    };
                ...
                fn size<T: ::pilota::thrift::TLengthProtocol>(&self, protocol: &mut T) -> usize {
                    ...
                    protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
                        name: "GetItemRequest",
                    }) + protocol.i32_field_len(Some(1), (*&self.command).into())
                        + self
                            .key
                            .as_ref()
            ...
            pub struct GetItemResponse {
                ...
                pub res: ::std::option::Option<::pilota::FastStr>,
            }
            #[::async_trait::async_trait]
            impl ::pilota::thrift::Message for GetItemResponse {
                fn encode<T: ::pilota::thrift::TOutputProtocol>(
                    ...
                    protocol.write_struct_begin(&struct_ident)?;
                    protocol.write_bool_field(1, *&self.flag)?;
                    if let Some(value) = self.res.as_ref() {
                        protocol.write_faststr_field(2, (value).clone())?;
                    }
                    protocol.write_field_stop()?;
                    protocol.write_struct_end()?;
                ...
                fn decode<T: ::pilota::thrift::TInputProtocol>(
                    ...
                    if let Err(err) = (|| {
                        loop {
                            ...
                            match field_ident.id {
                                ...
                                {
                                    flag = Some(protocol.read_bool()?);
                                }
                                Some(2)
                                    if field_ident.field_type
                                        == ::pilota::thrift::TType::Binary =>
                                {
                                    res = Some(protocol.read_faststr()?);
                                }
                                _ => {
                                    protocol.skip(field_ident.field_type)?;
                                }
                    ...
                    let Some(flag) = flag else {
                        return Err(::pilota::thrift::DecodeError::new(
                            ::pilota::thrift::DecodeErrorKind::InvalidData,
                            "field flag is required".to_string(),
                        ));
                    };

                    let data = Self { flag, res };
                    Ok(data)
                }
                        ...
                        loop {
                            ...
                            match field_ident.id {
                                Some(1)
                                    if field_ident.field_type == ::pilota::thrift::TType::Bool =>
                                {
                                    flag = Some(protocol.read_bool().await?);
                                }
                                Some(2)
                                    if field_ident.field_type
                                        == ::pilota::thrift::TType::Binary =>
                                {
                                    res = Some(protocol.read_faststr().await?);
                                }
                                _ => {
                                    protocol.skip(field_ident.field_type).await?;
                                }
                ...
                fn size<T: ::pilota::thrift::TLengthProtocol>(&self, protocol: &mut T) -> usize {
                    ...
                    protocol.struct_begin_len(&::pilota::thrift::TStructIdentifier {
                        name: "GetItemResponse",
                    }) + protocol.bool_field_len(Some(1), *&self.flag)
                        + self
                            .res
                            .as_ref()
                            .map_or(0, |value| protocol.faststr_field_len(Some(2), value))
